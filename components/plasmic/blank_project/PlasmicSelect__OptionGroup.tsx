...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: wxIrHL94XHR/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 0jkahGZ5HbE/render
...
export const defaultSelect__OptionGroup__Args: Partial<PlasmicSelect__OptionGroup__ArgsType> =
  {};
...
function PlasmicSelect__OptionGroup__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultSelect__OptionGroup__Args, props.args);
  const $props = args;
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__nEuWh)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__xM2Uz)}
              />
            </React.Fragment>
          ),
          value: args.children
