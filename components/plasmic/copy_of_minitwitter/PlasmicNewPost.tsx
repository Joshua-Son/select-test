...
import Button from "../../Button"; // plasmic-import: kppNecCpAP-/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_copy_of_minitwitter.module.css"; // plasmic-import: 5t7S5k969EXd9MSJ9ASYQC/projectcss
import sty from "./PlasmicNewPost.module.css"; // plasmic-import: sFoivAvf-j1/css
...
export const defaultNewPost__Args: Partial<PlasmicNewPost__ArgsType> = {};
...
function PlasmicNewPost__RenderFunc(props: {
  ...
  const args = Object.assign({}, defaultNewPost__Args, props.args);
  const $props = args;
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <div className={classNames(projectcss.all, sty.freeBox__nBciE)}>
            <div className={classNames(projectcss.all, sty.freeBox__oJze)}>
              <div className={classNames(projectcss.all, sty.freeBox__gKm46)}>
                <textarea
