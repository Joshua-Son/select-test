...
import sty from "./PlasmicPost.module.css"; // plasmic-import: rfl638tLfUW/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: LMrHWnKGrLS/icon
...
export type PlasmicPost__VariantsArgs = {
  ...
  ttmp?: SingleBooleanChoiceArg<"ttmp">;
};
...
function PlasmicPost__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___3T1Zn)}>
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <div className={classNames(projectcss.all, sty.freeBox__x00XN)}>
        {p.renderPlasmicSlot({
